...
if("${CMAKE_OSX_ARCHITECTURES}" STREQUAL "arm64" OR
   ...
   "${CMAKE_HOST_SYSTEM_PROCESSOR}" STREQUAL "aarch64")
        ...
        if(NOT CMAKE_SYSTEM_NAME STREQUAL "iOS")
                ...
                # iOS ARM64: target armv8.4-a (A12+, minimum for iOS 18 / PCSX2 JIT)
                # -ffast-math: safe for emulator (no NaN-dependant logic in hot paths)
                add_compile_options(
                        "-march=armv8.4-a+simd+crypto"
                        "-ffast-math"
                        "-fno-finite-math-only"
                )
                # Release-only: full optimization + link-time optimization
                add_compile_options(
                        "$<$<CONFIG:Release>:-O3>"
